    ...
    return (
        <div className={styles.home_about}>
            ...
            <div className={styles.home_about_content}>
                <div className={styles.home_about_images}>
                    <div className={styles.home_about_main_image_wrapper}>
                    ...
                    <div className={styles.home_about_images_select}>
                        <img onClick={() => changeSrc(1)} src={biz1} className={currentImg === 1 ? styles.image_active : ""} alt="Stock 1"/>
                        <img onClick={() => changeSrc(2)} src={biz2} className={currentImg === 2 ? styles.image_active : ""} alt="Stock 2"/>
                        <img onClick={() => changeSrc(3)} src={biz3} className={currentImg === 3 ? styles.image_active : ""} alt="Stock 3"/>
                        <img onClick={() => changeSrc(4)} src={biz4} className={currentImg === 4 ? styles.image_active : ""} alt="Stock 4"/>
                        <img onClick={() => changeSrc(5)} src={biz5} className={currentImg === 5 ? styles.image_active : ""} alt="Stock 5"/>
                    </div>
                </div>
                <div className={styles.home_about_desc}>
                    <div className={styles.home_about_desc_entry}>
